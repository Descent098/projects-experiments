...
//
extern __declspec(dllexport) Suggestion* check_dictionary_similarity(char* inputWord);
...
//	*C.Suggestion: A pointer to the suggestion object with the word and it's likelihood
//
extern __declspec(dllexport) Suggestion* check_dictionary_similarity_levenstein(char* inputWord);
extern __declspec(dllexport) void free_suggestion(Suggestion* suggestionReference);
